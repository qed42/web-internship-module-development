...
namespace Drupal\ajinkya_form_api\Controller;

use Drupal\ajinkya_form_api\ForecastClientInterface;
use Drupal\Core\Controller\ControllerBase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Controller for ajinkya_form_api.weather_page route.
 */
class WeatherPage extends ControllerBase {
   ...
   * Forecast API client.
   *
   * @var \Drupal\ajinkya_form_api\ForecastClientInterface
   */
   ...
   *
   * @param \Drupal\ajinkya_form_api\ForecastClientInterface $forecast_client
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('ajinkya_form_api.forecast_client')
    );
  }
