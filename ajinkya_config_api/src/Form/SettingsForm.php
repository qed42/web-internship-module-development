...
namespace Drupal\ajinkya_config_api\Form;

use Drupal\Core\Form\ConfigFormBase;
use Drupal\Core\Form\FormStateInterface;

/**
 * Configure ajinkya_config_api settings for this site.
 */
final class SettingsForm extends ConfigFormBase {
   ...
   */
  const SETTINGS = 'ajinkya_config_api.settings';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('ajinkya_config_api configuration updated.'));
  }
